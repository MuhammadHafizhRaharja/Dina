...
?>
    ...
    <div class="gallery" data-aos="fade-down" data-aos-duration="600" data-aos-delay="100">
        <div class="main-photo">
            <img src="Assets/tanahlot2.jpg" height="300" width="2000">
            <div class="overlay">
                <h1>Tanah Lot</h1> 
            </div>
        </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
        <div class="content">
            <h1>About</h1>
            <p>Tanah Lot in Bali is one of the island’s most iconic and picturesque tourist destinations, 
                famous for its stunning offshore temple perched on a rock formation surrounded by 
                the sea. This sacred site is a significant cultural landmark and a must-visit for 
                anyone exploring Bali. What makes Tanah Lot particularly captivating is its breathtaking 
                sunset views, where the temple silhouette against the golden sky creates a magical and 
                unforgettable scene. Visitors can explore the temple grounds during low tide, while 
                nearby areas offer cultural performances, traditional markets selling Balinese souvenirs, 
                and local food stalls. The Batu Bolong Temple, another smaller temple located nearby on a 
                rocky archway, is also a favorite spot for visitors. With its combination of natural 
                beauty, spiritual significance, and vibrant local culture, Tanah Lot offers an experience 
                that beautifully showcases the essence of Bali.</p>
        ...
        <div class="sidebar">
            ...
            <div class="option">
                ...
                <p>Pickup included</p>
                <p>2 Adults x Rp.650.000,00</p>
                <p>Total Rp.1.300.000,00</p>
