...
?>
    ...
    <div class="gallery" data-aos="fade-down" data-aos-duration="600" data-aos-delay="100">
        <div class="main-photo">
            <img src="Assets/tirta empul2.jpg" height="300" width="2000">
            <div class="overlay">
                <h1>Tirta Empul</h1> 
            </div>
        </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
        <div class="content">
            <h1>About</h1>
            <p>Tirta Empul in Bali is a sacred water temple located in Tampaksiring, renowned for its 
                spiritual significance and stunning architecture. The temple is famous for its holy 
                spring water, where Balinese Hindus and visitors participate in a traditional 
                purification ritual called *melukat*. The bathing pools, fed by crystal-clear water 
                from the sacred spring, are believed to cleanse the body, mind, and soul. The temple's 
                intricate stone carvings and tranquil surroundings add to its allure, making it a serene 
                and culturally rich experience. Nearby attractions include the majestic Presidential 
                Palace, built during Indonesia's first presidency, and lush rice terraces that showcase 
                Bali's natural beauty. Tirta Empul offers visitors a unique opportunity to connect 
                with Balinese spirituality, culture, and heritage, making it one of the island’s 
                most cherished destinations.</p>
        ...
        <div class="sidebar">
            ...
            <div class="option">
                ...
                <p>Pickup included</p>
                <p>2 Adults x Rp.300.000,00</p>
                <p>Total Rp.600.000,00</p>
