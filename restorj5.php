...
?>
    ...
    <div class="container-resto">
        ...
        <div class="contact-resto" data-aos="fade-left" data-aos-duration="1500" data-aos-delay="300">
             <h2>Nusa Gastronomy</h2>
            <img alt="Restaurant exterior with tables and chairs" height="200" src="media/rj5.jpg" width="300"/>
            <div >
                <p style="padding-top: 20px; color: white;"><strong>Location</strong></p>
                <p style="font-size: 14px;">Jl. Kemang Sel. No.81, Bangka, Kemang, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12730</p>
