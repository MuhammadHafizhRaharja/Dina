        ...
        <section id="contact-us">
            <div class="container" data-aos="fade-down" data-aos-duration="1000" data-aos-delay="300">
                ...
                <div class="row col-bg">
                    <div class="col-2">
                        <div>
                            <p><i class="fa fa-map-marker" id="icon3"></i> Address: Bandung, Indonesia</p>
                            <p><i class="fa fa-phone" id="icon3"></i> Phone: +62 8123456789</p>
                            <p><i class="fa fa-envelope" id="icon3"> </i> Email: dina@gmail.com</p>
                            <p>&nbsp;</p>
                        </div>
                    </div>
                    <div class="col-2">
