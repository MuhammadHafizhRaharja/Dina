...
?>
    ...
    <div class="container-resto">
        ...
        <div class="contact-resto" data-aos="fade-left" data-aos-duration="1500" data-aos-delay="300">
             <h2>Sierra Café & Lounge</h2>
            <img alt="Restaurant exterior with tables and chairs" height="200" src="media/restob4.jpg" width="300"/>
            <div >
                <p style="padding-top: 20px; color: white;"><strong>Location</strong></p>
                <p style="font-size: 14px;">Jl. Bukit Pakar Timur No.33, Ciburial, Kec. Cimenyan, Kabupaten Bandung, Jawa Barat 40198</p>
