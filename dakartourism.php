<html>
<head>
    <title>Dago Pakar, Bandung</title>
...
?>
    ...
    <div class="gallery" data-aos="fade-down" data-aos-duration="600" data-aos-delay="100">
        <div class="main-photo">
            <img src="Assets/dakartourism.jpg" height="300" width="2000">
            <div class="overlay">
                <h1>Dago Pakar</h1>
            </div>
        </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
        <div class="content">
            <h1>About</h1>
            <p> located on the hills of Dago, offers a peaceful retreat in nature. This natural 
                park is well-known for its hiking trails, scenic viewpoints, and lush greenery. 
                It’s an excellent destination for outdoor enthusiasts, with the added benefit 
                of cool mountain air and the opportunity to enjoy the fresh environment away 
                from the busy city center</p>
        ...
        <div class="sidebar">
            ...
            <div class="option">
                ...
                <p>Pickup included</p>
                <p>2 Adults x Rp.80.000,00</p>
                <p>Total Rp.160.000,00</p>
