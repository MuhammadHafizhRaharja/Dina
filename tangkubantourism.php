<html>
<head>
    <title>Tangkuban Perahu, Bandung</title>
...
?>
    ...
    <div class="gallery" data-aos="fade-down" data-aos-duration="600" data-aos-delay="100">
        <div class="main-photo">
            <img src="Assets/tangkubantourism.jpg" height="300" width="2000">
            <div class="overlay">
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
        <div class="content">
            <h1>About</h1>
            <p>a majestic active volcano located just outside the city. Known for its dramatic craters, 
                visitors come here to experience the surreal landscape, breathe in the cool mountain air,
                 and explore the volcanic activity. The site is also steeped in local legend, with the 
                 story of Sangkuriang, making it not only a nature lover’s paradise but also a place 
                 where history and folklore come alive.</p>
        ...
        <div class="sidebar">
            ...
            <div class="option">
                ...
                <p>Pickup included</p>
                <p>2 Adults x Rp.50.000,00</p>
                <p>Total Rp.100.000,00</p>
