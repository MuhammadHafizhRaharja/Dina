    ...
    <div class="container px-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-3 mb-4 text-center" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="300">
                <h2 class="mb-3" style="text-align: center">Umana Bali Resorts</h2>
                <img src="media/umanabali.jpg" alt="Room Image" class="img-fluid rounded mb-3" width="300px">
                <p><strong>Location:</strong><br>Jl. Melasti, Ungasan, Kec. Kuta Sel., Kabupaten Badung, Bali 80364</p>
