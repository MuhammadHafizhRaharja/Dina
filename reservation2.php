...
// Misal hotel yang dipilih/ditampilkan adalah hotel_id = 2
$hotel_id = 2;
    ...
    <div class="container px-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-3 mb-4 text-center" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="300">
                <h2 class="mb-3">Raffles Bali</h2>
                <img src="media/raflessbali.jpg" alt="Room Image" class="img-fluid rounded mb-3" width="300px">
                <p><strong>Location:</strong><br>Jl. Karang Mas Sejahtera No.1A, Jimbaran, Kec. Kuta Sel., Kabupaten Badung, Bali 80361</p>
