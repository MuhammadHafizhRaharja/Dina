...
?>
    ...
    <div class="container-resto">
        ...
        <div class="contact-resto" data-aos="fade-left" data-aos-duration="1500" data-aos-delay="300">
             <h2>Café D'Pakar</h2>
            <img alt="Restaurant exterior with tables and chairs" height="200" src="media/restob2.webp" width="300"/>
            <div >
                <p style="padding-top: 20px; color: white;"><strong>Location</strong></p>
                <p style="font-size: 14px;">Jalan Dago Pakar Utara Sekejolang, Ciburial, Bandung, Jawa Barat, 40198</p>
