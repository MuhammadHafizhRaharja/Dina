<html>
<head>
    <title>Farmhouse Lembang, Bandung</title>
...
?>
    ...
    <div class="gallery" data-aos="fade-down" data-aos-duration="600" data-aos-delay="100">
        <div class="main-photo">
            <img src="Assets/farmhoustour.jpg" height="300" width="2000">
            <div class="overlay">
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
        <div class="content">
            <h1>About</h1>
            <p>a distinctly European village experience with its charming cottages, picturesque 
                scenery, and an on-site petting zoo. It’s a wonderful destination for families 
                and photography enthusiasts, as it provides many Instagram-worthy spots, along 
                with delicious food and drink options.</p>
        ...
        <div class="sidebar">
            ...
            <div class="option">
                ...
                <p>Pickup included</p>
                <p>2 Adults x Rp.40.000,00</p>
                <p>Total Rp.80.000,00</p>
