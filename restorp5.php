...
?>
    ...
    <div class="container-resto">
        ...
        <div class="contact-resto" data-aos="fade-left" data-aos-duration="1500" data-aos-delay="300">
             <h2>Kampung Laut Restaurant</h2>
            <img alt="Restaurant exterior with tables and chairs" height="200" src="media/restop5.jpg" width="300"/>
            <div >
                <p style="padding-top: 20px; color: white;"><strong>Location</strong></p>
                <p style="font-size: 14px;">jayamart, Seberang Astra Honda, masuk lorong sebelah, Jl. Klp. 2 No.18, Entrop, Jayapura City, Papua 99221</p>
