<html>
<head>
    <title>Cihampelas Walk, Bandung</title>
...
?>
    ...
    <div class="gallery" data-aos="fade-down" data-aos-duration="600" data-aos-delay="100">
        <div class="main-photo">
            <img src="Assets/ciwalktourism.jpg" height="300" width="2000">
            <div class="overlay">
                <h1>Cihampelas Walk</h1>
            </div>
        </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
        <div class="content">
            <h1>About</h1>
            <p> Cihampelas Walk (Ciwalk) is a must-visit destination. Located on Cihampelas Street, 
                this modern shopping mall is famous for its combination of retail outlets, 
                dining options, and entertainment facilities. It’s also known for the colorful 
                and quirky "jeans" street art that decorates the walls of the buildings along 
                the street, adding a fun and creative touch to the shopping experience.</p>
