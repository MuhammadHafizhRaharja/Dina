...
?>
    ...
    <div class="container-resto">
        ...
        <div class="contact-resto" data-aos="fade-left" data-aos-duration="1500" data-aos-delay="300">
             <h2>SKYE Bar & Restaurant</h2>
            <img alt="Restaurant exterior with tables and chairs" height="200" src="media/rj4.jpg" width="300"/>
            <div >
                <p style="padding-top: 20px; color: white;"><strong>Location</strong></p>
                <p style="font-size: 14px;">BCA Tower Lt. 56, Jl. M.H. Thamrin No. 1, RT.001 / RW.005, Menteng, RT.1/RW.5, Menteng, Kec. Menteng, Kota Jakarta Pusat.</p>
