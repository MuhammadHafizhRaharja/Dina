            ...
            <div class="row" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="300">
                <div class="col-md-6 p-4">
                    <div class="card border-0">
                        <img src="media/hotelP3.jpg" class="card-img-top" alt="Room Image">
                        <div class="card-body px-0">
                            <h2 class="card-title ls-3">Aston Niu Manokwari Hotel</h2>
                            <p class="card-text mb-0">Max Guests: 2</p>
                            <p class="card-text mb-0">Tipe : Luxury Room</p>
                            <p class="card-text mb-0">Price: Rp980..000/night</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 p-4">
