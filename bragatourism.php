<html>
<head>
    <title>Braga City Walk, Bandung</title>
...
?>
    ...
    <div class="gallery" data-aos="fade-down" data-aos-duration="600" data-aos-delay="100">
        <div class="main-photo">
            <img src="Assets/bragatourism.jpg" height="300" width="2000">
            <div class="overlay">
                <h1>Braga City Walk</h1>
            </div>
        </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
        <div class="content">
            <h1>About</h1>
            <p> Jalan Braga offers a glimpse into Bandung’s colonial past. 
                This iconic street is lined with beautiful colonial-era architecture, 
                cafes, galleries, and boutique shops, making it one of the most charming 
                areas in the city. Visitors often stroll along the street, soaking in 
                the atmosphere and stopping by the many shops and cafes that line the 
                road, creating a perfect mix of culture, history, and leisure.</p>
        ...
        <div class="sidebar">
            ...
            <div class="option">
                ...
                <p>Pickup included</p>
                <p>2 Adults x Rp.150.000,00</p>
                <p>Total Rp.300.000,00</p>
