<html>
<head>
    <title>Gedung Sate, Bandung</title>
...
?>
    ...
    <div class="gallery" data-aos="fade-down" data-aos-duration="600" data-aos-delay="100">
        <div class="main-photo">
            <img src="Assets/gedungsatetourism.jpg" height="300" width="2000">
            <div class="overlay">
                <h1>Gedung Sate</h1>
            </div>
        </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
        <div class="content">
            <h1>About</h1>
            <p> a landmark building that stands as a symbol of Bandung’s architectural 
                and governmental heritage. The building, with its distinct design featuring 
                a unique sate (skewer) on the roof, houses the Governor's office and is 
                surrounded by a lovely park. It’s a great spot to learn about the city’s 
                apast while enjoying the surrounding green spaces.</p>
        ...
        <div class="sidebar">
            ...
            <div class="option">
                ...
                <p>Pickup included</p>
                <p>2 Adults x Rp.10.000,00</p>
                <p>Total Rp.20.000,00</p>
