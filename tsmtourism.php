<html>
<head>
    <title>Trans Studio Bandung, Bandung</title>
...
?>
    ...
    <div class="gallery" data-aos="fade-down" data-aos-duration="600" data-aos-delay="100">
        <div class="main-photo">
            <img src="Assets/tsmtourism.jpg" height="300" width="2000">
            <div class="overlay">
                <h1>Trans Studio Bandung</h1>
            </div>
        </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
        <div class="content">
            <h1>About</h1>
            <p>Trans Studio Bandung stands out as one of the largest indoor theme parks in Indonesia. 
                The park is filled with thrilling rides, live performances, and entertainment that 
                cater to both children and adults. It offers a fully immersive experience where 
                visitors can enjoy hours of fun without worrying about the weather, making it a popular 
                spot for families and thrill-seekers.</p>
        ...
        <div class="sidebar">
            ...
            <div class="option">
                ...
                <p>Pickup included</p>
                <p>2 Adults x Rp.250.000,00</p>
                <p>Total Rp.500.000,00</p>
