...
?>
    ...
    <div class="container-resto">
        ...
        <div class="contact-resto" data-aos="fade-left" data-aos-duration="1500" data-aos-delay="300">
             <h2>Bunga Rampai</h2>
            <img alt="Restaurant exterior with tables and chairs" height="200" src="media/rj3.jpg" width="300"/>
            <div >
                <p style="padding-top: 20px; color: white;"><strong>Location</strong></p>
                <p style="font-size: 14px;">Jl. Teuku Cik Ditiro No.35 10, RT.10/RW.5, Menteng, Kec. Menteng, Kota Jakarta Pusat, Daerah Khusus Ibukota Jakarta 10310</p>
