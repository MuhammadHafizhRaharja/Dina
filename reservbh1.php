    ...
    <div class="container px-4">
        <div class="row align-items-center">
            ...
            <div class="col-md-3 mb-4 text-center" data-aos="fade-right" data-aos-duration="1500" data-aos-delay="300">
                <h2 class="mb-3" style="text-align: center">GH Universal Hotel</h2>
                <img src="media/hotel1.jpg" alt="Room Image" class="img-fluid rounded mb-3" width="300px">
                <p><strong>Location:</strong><br>Jl. Dr. Setiabudi No.376, Ledeng, Kec. Cidadap, Kota Bandung, Jawa Barat 40143</p>
