<html>
<head>
    <title>Taman Hutan Raya, Bandung</title>
...
?>
    ...
    <div class="gallery" data-aos="fade-down" data-aos-duration="600" data-aos-delay="100">
        <div class="main-photo">
            <img src="Assets/tahuratourism.jpg" height="300" width="2000">
            <div class="overlay">
                <h1>Taman Hutan Raya</h1>
            </div>
        </div>
    ...
    <div class="container" data-aos="fade-up" data-aos-duration="900" data-aos-delay="500">
        <div class="content">
            <h1>About</h1>
            <p> This expansive botanical garden and nature reserve in Dago is known 
                for its tranquil environment, with scenic walking paths, lush flora, 
                and wildlife. Visitors can hike through the forest, explore historical 
                sites like the Japanese caves, and enjoy the natural beauty of the area, 
                making it a perfect place for those looking to relax and reconnect with nature.</p>
